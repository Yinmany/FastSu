...
{
    private readonly Slots<ANetChannel> _connections = new(1000);
    ...
    public async Task OnConnectedAsync<TState>(TState state, IPEndPoint remoteIp, NetChannelFactoryDelegate<TState> factory)
    {
